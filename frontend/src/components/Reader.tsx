                        ...
                        {selectedHighlight ? (
                            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                                ...
                                {selectedHighlight.type === 'vocabulary' && (
                                    <button
                                        onClick={() => onSaveVocabulary(selectedHighlight.text)}
                                        className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold shadow-lg shadow-blue-500/20 active:scale-95 transition-all"
                                    >
                                        <Plus size={18} />
