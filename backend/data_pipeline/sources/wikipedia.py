...
class WikipediaSource(DataSourceBase):
    ...
    CATEGORY_KEYWORDS = {
        "Technology": [
            ...
            "software engineering", "internet", "robotics"
        ],
        "Science": [
        ...
        "History": [
            "world war", "ancient history", "medieval history",
            "industrial revolution", "renaissance"
        ],
        "Geography": [
            "countries of the world", "capital cities", "mountains",
            "rivers", "climate"
        ],
        "Culture": [
